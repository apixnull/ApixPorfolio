  ...
  return (
    ...
    >
      ...
      <div className="text-center z-10 px-4">
        <h1 className="text-5xl md:text-7xl font-semibold mb-6 bg-gradient-to-r from-blue-500 to-cyan-600 bg-clip-text text-transparent leading-right">
          Hi,I'm Jasper Cesa
        </h1>
        <p className="text-lg text-gray-400 mb-8 max-w-lg mx-auto">
          I'm an aspiring Full Stack Developer with a passion for building
          modern web applications using React, Flask, and PostgreSQL.
