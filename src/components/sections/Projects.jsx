        ...
        <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.2)] transition">
                    <h3 className="text-xl font-bold mb-2">Rent Ease</h3>
                    <p className="text-gray-400 mb-4">
                        RentEase is a smart rental management platform that helps landlords automate rent collection, lease tracking, and maintenance requests. It also uses AI to suggest optimal rental pricing based on market trends. (Ongoing)
                    </p>
